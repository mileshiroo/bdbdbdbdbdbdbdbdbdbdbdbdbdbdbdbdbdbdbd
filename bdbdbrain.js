...
function setup() {
    ...
    if(loadedFrom != local && loadedFrom.slice("http://".length,17) != "partsparts") {
        ...
        fbUrl += defaultRoom;
        vex.dialog.alert('<p>partsparts.parts by @mileshiroo</p><p>drag parts around on the screen</p> <p>add your own</p> <p>or create a new room like: http://newsecretroom.partsparts.parts</p>')
    }
